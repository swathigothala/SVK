<%-- 
    Document   : CreditNoteView
    Created on : Jul 8, 2017, 12:16:07 PM
    Author     : ch.mounika
--%>
                 ...
                 <div id="printablearea">   
                            ...
                            <div class="box box-warning">          
                                ...
                                <s:form action="retrieveTaxInvoice" method="post" theme="css_xhtml">
                                    <table border="1" style="width:100%;">
                                       ...
                                       <table border="1" style="width:100%">
                                            <td align="center">
                                                 <img src="dist/img/SVK_Logo_2.png" class="img-circle" alt="User Image">
                                            </td>
                                                <td align="center">
                                                    
                                                <img src="dist/img/SVk_Head_1.png" class="img-circle" alt="User Image">
                                                <h3 style="font-family:arial,sans-serif;font-weight:bold;margin-top: -5px;margin-bottom: 5px !important;">Credit Note</h3>
                                     ...
                                     <s:iterator value="invlist">
                                            <tr>
                                                ...
                                                <td style="border-color:white">
                                                    ...
                                                    <label id="i">Against Invoice:</label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td colspan="2" style="border-color:white">
                                                    ...
                                                    <label id="i">Date of Issue:</label>
                                                </td>
                                                <td colspan="2">
                    ...
                    <s:date format="dd-MM-yyyy" var="date1" name="%{invoiceDate}"/> <s:property value="%{date1}" ></s:property>
                                                ...
                                                <td style="border-color:white">
                                                    ...
                                                    <label id="i">Date of Invoice :</label>
                                                </td>
                                                <td>
                                                  <s:date format="dd-MM-yyyy" var="date1" name="%{invoiceDate}"/> <s:property value="%{date1}" ></s:property>
                                          ...
                                          <s:iterator value="invlist"> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <s:textarea id="border" readonly="true" value="%{billToAddress}" name="add1" cols="30" rows="4" />
                                                </td>
                                                <td style="border-color:white; padding-bottom: 50px;">
                                                ...
                                                <td>
                                                    ...
                                                    <s:textarea id="border" readonly="true" value="%{shipAddress}" name="add2" rows="4" cols="30"/>
                                                </td>
...
<tr>
    ...
    <table border="1" style="width:100%">
       ...
       <td><s:property value="gstReverseCharge"/></td>
              ...
              <td colspan="2" style="font-size: 12px;" style="font-size: 14px;">Ceritified that the particulars given above are true and correct</td>  
    </tr>
        <tr>
...
<s:date format="MM-dd-yyyy" var="date1" name="%{invoiceDate}"/> <s:property value="%{date1}" ></s:property>
                                            ...
                                            <tr>
                                                ...
                                                <td>
     <s:date format="MM-dd-yyyy" var="date1" name="%{dateOfSupply}"/> <s:property value="%{date1}" ></s:property>
