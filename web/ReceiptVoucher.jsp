...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="adminlogin.php" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
       <span class="logo-mini"><b>V</b>T</span>
      <!-- logo for regular state and mobile devices -->
       <span class="logo-lg"><b>Vehicle</b>&#x00A0;Tracking</span>
    </a>
...
<s:form action="insertInvoice" theme="css_xhtml" name="myForm" onsubmit="return validateForm()">
      <!-- row -->
      <div class="row">
        <div class="col-md-12">
          <!-- jQuery Knob -->
    ...
    <label>Voucher Number</label>
     <s:textfield id="i"  name="vname" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Voucher Number" size="50" />
    </td>
    <td>&#x00A0;</td>
    ...
    <div class="block">
        ...
        <td style="padding-left: 80px;">
            <label style="padding-top: 23px;">Voucher Date</label>
 <div class="input-group date">
    ...
    <td>&#x00A0;</td>
    <td rowspan="2" style="padding-left: 130px;">
    <label style="padding-top: 20px;">Address of Receiver</label>
      <s:textarea id="i" name="receiverAddress"  rows="5" cols="20" cssClass="form-control" placeholder="Enter Receiver Address"/>
    </td>
    </div>
           </tr>
    ...
    <div class="block bootstrap-timepicker">
        ...
        <td style="padding-left: 80px;">
    <label style="padding-top: 23px;">Place of Supply</label>
     <s:textfield id="i"  name="logindto.urInvoiceSerialNo" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Place of Supply" size="50" />
    </td>
    <td>&#x00A0;</td>
    ...
    <s:select id="i" name="logindto.supplyPlace" list="{'yes','no'}" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Place of supply" headerKey=" " headerValue="--select--" />
   ...
   <td style="padding-left: 130px;">
    ...
    <div class="block">
        ...
        <td style="padding-left: 80px;">
    <label>State</label>
        <s:textfield id="i" name="logindto.supplyPlace" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="State" size="50" />
   ...
   <td style="padding-left: 130px;">
    ...
    <label>State Code</label>
        <s:textfield id="i" name="logindto.supplyPlace" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Code" size="50" />
   ...
   <td style="padding-left: 130px;">
    ...
    <table  border="1" style="border-collapse: collapse;" id="one1"> 
      <tr>
         ...
         <th rowspan="2">Grades Description</th>
          <th rowspan="2" style="padding-left: 20px;">HSN Code(GST)</th>
          <th rowspan="2" style="padding-left: 20px;">Taxable value</th>
          <th colspan="2" style="padding-left: 110px;"> CGST </th> 
         <th colspan="2" style="padding-left: 110px;">SGST</th>
          <th rowspan="2" style="padding-left: 20px;">Total Advance Received</th>
       
     </tr>
       <tr>
         <th style="padding-left: 40px;">Rate </th>
         <th style="padding-left: 40px;">Amount </th>
         <th style="padding-left: 40px;">Rate </th>
         <th style="padding-left: 40px;">Amount </th>
       </tr>
   ...
   <tr>
       ...
       <td style="width: 13%"><s:select headerKey=" " headerValue="--select--" list="{'aa','bb'}" name="logindto.goodDescription" id="i" cssClass="form-control"  theme="simple"></s:select></td>  
      ...
      <tr>
   <td width="25.4%" colspan="3" class="text-center"><b>TOTAL</b></td>  
   <td ><s:textfield name="suplydto.totTaxVal" size="20" id="i" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
   <td><s:textfield name="suplydto.totCgst" id="i" cssClass="form-control"  theme="simple"></s:textfield></td>
   <td><s:textfield name="suplydto.totSgst" id="i" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
<td><s:textfield name="suplydto.totIgst" id="i" cssClass="form-control"  theme="simple"></s:textfield></td>
<td><s:textfield name="suplydto.totSgst" id="i" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
<td><s:textfield name="suplydto.totIgst" id="i" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
    ...
    <div class="block">
        ...
        <s:textfield id="i" name="logindto.supplyPlace" readonly="true" onkeypress="return isDecimalKey(event)" cssClass="form-control"  size="60" />
   
        </td>
    <td>&#x00A0;</td>
   <td style="padding-left: 130px;">
    <label>Total Tax Amount</label>
    <s:textfield id="i"  name="receiverGstinNo" readonly="true" onkeypress="return isDecimalKey(event)" cssClass="form-control"  size="50" />
   </td>
    </div>
           </tr>
            <td><br/></td>   
    ...
    <div class="block">
        ...
        <td style="padding-left: 80px;">
    <label>Tax on CGST</label>
        <s:textfield id="i" name="logindto.supplyPlace" readonly="true" onkeypress="return isDecimalKey(event)" cssClass="form-control"  size="50" />
   ...
   <td style="padding-left: 130px;">
    <label>GST on Reverse Charge</label>
        <s:textfield id="i" name="logindto.supplyPlace" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="GST on reverse charge" size="50" />
    </td>
    </div>
           </tr>
