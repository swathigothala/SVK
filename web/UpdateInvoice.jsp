...
<s:form action="updateinvoice" theme="css_xhtml" onsubmit="return validateForm()">
          ...
          <div class="box box-solid">
            ...
            <div class="box-header">
                ...
                <s:iterator value="invlist"> 
                    ...
                    <s:hidden name="tdto.generatedby" value="%{curdate}"/>
             <table>
                 <tr>
    <div class="block">
        &nbsp;
    ...
    <label>Invoice No: </label>
     <s:if test="#myobj.lType == 'user'">  
              <s:textfield id="invoice" value="00%{invoiceNo}" readonly="true"  name="tdto.invoiceNo" onkeypress="return isAlphaKey(event)" cssClass="form-control" placeholder="Your Invoice Number" size="50" />

            </s:if>
            <s:else>
                
           <s:textfield id="invoice" value="00%{invoiceNo}"  name="tdto.invoiceNo" onkeypress="return isNumberKey(this,event)" cssClass="form-control" placeholder="Your Invoice Number" size="50" />
   ...
   <td style="padding-left: 130px;">
    <label>Date of Supply:</label>
     ...
     <s:textfield readonly="true"  data-date-format="dd/mm/yyyy" value="%{date3}" name="tdto.dateOfSupply" onkeypress="return isDecimalKey(event)"  displayFormat="dd-mm-yy" cssClass="form-control " placeholder="Select Date" size="50" />
       </div>
   </td>
    ...
    <s:textfield id="state" name="tdto.state"  cssClass="form-control" value="Andhra Pradesh" readonly="true" size="30" />
     ...
     <label>Code: </label>
     <s:textfield id="code" name="tdto.code" readonly="true" cssClass="form-control" value="%{code}"  placeholder="Your GSTIN Number" size="15" />
            </div>
            </div>
            </td>
        <td>&#X00A0;</td>
   ...
   <td style="padding-left: 130px;">
    ...
    <div class="block">
        ...
        <td style="padding-left: 80px;">
    <label>Address:</label>
    <s:textarea id="raddr" name="tdto.billToAddress" value="%{billToAddress}"  rows="4" cols="20" cssClass="form-control recAdd" placeholder="Enter Receiver Address"/>
    </td>
    <td>&#x00A0;</td>
   <td style="padding-left: 130px;">
       <input type="checkbox" name="billingtoo1" onclick="FillBilling1(this.form)" id="chk-01"/>
    <label>Address: (Tick if Address is same)</label>
    <s:textarea id="caddr" name="tdto.shipAddress" value="%{shipAddress}"  rows="4" cols="20" cssClass="form-control conAdd" placeholder="Enter Consignee Address"/>
    </td>
    </div>
           </tr>
   ...
   <td style="padding-left: 130px;">
    ...
    <s:textfield id="i" name="tdto.billTostate"  readonly="true" cssClass="form-control recS" value="Andhra Pradesh" size="30" />
     ...
     <div style="float: right">
     <label>Code: </label>
     <s:textfield id="i" name="tdto.billToCode" readonly="true" value="%{billToCode}"  cssClass="form-control" size="15" />
            </div>
            </div>
        </td>
    <td>&#x00A0;</td>
...
<!--                <table id="two1" >
   ...
   <tr>
       <td style="padding: 0;"> <s:select list="glist" id="tri" cssStyle="width:140px;" value="%{productDesc}" name="tdto.productDesc" cssClass="form-control" headerKey="%{productDesc}" headerValue="%{productDesc}"  theme="simple"/></td>
       ...
       <td><s:textfield id="expprod" readonly="true" name="tdto.beforeTax" value="%{beforeTax}" onkeypress="return isNumberKey(this,event)"   cssClass="form-control expprod beforetax" theme="simple"></s:textfield></td>
       <td><s:textfield id="taxval" readonly="true" name="tdto.taxableValue" value="%{taxableValue}" onkeypress="return isNumberKey(this,event)"   cssClass="form-control taxval taxables" theme="simple"></s:textfield></td>
       ...
       <td><s:textfield name="tdto.cgAmt" readonly="true" id="cgstval" onkeypress="return isNumberKey(this,event)" value="%{cgAmt}"   cssClass="form-control cgstval" theme="simple"></s:textfield></td>
       ...
       <td><s:textfield name="tdto.sgAmt" readonly="true" id="sgstval" onkeypress="return isNumberKey(this,event)"  value="%{sgAmt}"  cssClass="form-control sgstval" theme="simple"></s:textfield></td>
       <td><s:textfield name="tdto.chTotal" readonly="true" id="totval" onkeypress="return isNumberKey(this,event)"  value="%{chTotal}" cssClass="form-control totval" theme="simple"></s:textfield></td>
   ...
   <tr>
       <td style="padding: 0;"> <s:select id="tri" list="glist" cssStyle="width:140px;" value="%{productDesc}" name="tdto.productDesc" cssClass="form-control" headerKey="%{productDesc}" headerValue="%{productDesc}"  theme="simple"/></td>
       <td><s:textfield name="tdto.hsnCode" readonly="true"  value="38245010" onkeypress="return isNumberKey(this,event)"   cssClass="form-control price valu1" theme="simple"></s:textfield></td>
       <td><s:textfield id="qtyval" name="tdto.qty" value="%{qty}" onkeypress="return isNumberKey(this,event)"   cssClass="form-control qtyval qtyvals" theme="simple"></s:textfield></td>
       <td><s:textfield id="valu1" name="tdto.afterTax" value="%{afterTax}" onkeypress="return isNumberKey(this,event)"   cssClass="form-control valu1 aftertax" theme="simple"></s:textfield></td>
       <td><s:textfield id="expprod" readonly="true" name="tdto.beforeTax" value="%{beforeTax}" onkeypress="return isNumberKey(this,event)"   cssClass="form-control expprod beforetax" theme="simple"></s:textfield></td>
   ...
   <td><s:textfield name="tdto.totalQty" value="%{totalQty}" size="16.9" id="totalqty" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
      
       <td><s:textfield name="tdto.totalValAtax" value="%{totalValAtax}" size="16.9" id="totalaftertax" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
   <td><s:textfield name="tdto.totalValBtax" value="%{totalValBtax}" size="16.9" id="totalbeforetax" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
   <td><s:textfield name="tdto.totalTaxval" value="%{totalTaxval}" size="16.9" id="totaltaxables" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
   <td width="8.5%">&#X00A0;</td>
   <td><s:textfield name="tdto.totalCgstAmt" value="%{totalCgstAmt}" size="16.9" id="totcgstamt" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
    <td width="8.5%">&#X00A0;</td>
    <td><s:textfield name="tdto.totalSgstAmt" value="%{totalSgstAmt}" size="16.9" id="totsgstamt" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
   <td><s:textfield  size="16.5" id="totamt" value="%{totalInv}" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
      </tr>
...
<script>
  ...
  function validateForm() {
                            ...
                            //        alert(z);
                              //          alert(a);
                                    if ((x === '0' || x==='0.0' || a==='undefined' || y === '0' || y==='0.0' || z === '0' || z==='0.0' || a==='0' || a==='0.0' || b==='0.0' || c==='0.0' || d==='0.0' || b==="0" || c==="0" || d==="0") || (($("#totalqty").val()).length === 0 || ($("#totalaftertax").val()).length === 0 || ($("#totalbeforetax").val()).length === 0 || ($("#totaltaxables").val()).length === 0 || ($("#totcgstamt").val()).length === 0 || ($("#totsgstamt").val()).length === 0 || ($("#totamt").val()).length === 0)) {
...
//                             var invid=parseInt(document.getElementById(invoice));
//                             alert(invid);
