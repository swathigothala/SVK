                                          ...
                                          <s:iterator value="invlist"> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <s:textarea id="border" cssStyle="resize: none;" readonly="true" value="%{billToAddress}" name="add1" cols="20" rows="7" />
                                                </td>
                                                <td style="border-color:white; padding-bottom: 50px;">
                                                ...
                                                <td>
                                                    ...
                                                    <s:textarea id="border" cssStyle="resize: none;" readonly="true" value="%{shipAddress}" name="add2" rows="7" cols="20"/>
                                                </td>
