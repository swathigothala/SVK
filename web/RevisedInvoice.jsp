...
<s:form action="insertInvoice" theme="css_xhtml">
    ...
    <label>Document Number</label>
     <s:textfield id="i"  name="logindto.urGstinNo" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Document Number" size="50" />
    </td>
    <td>&#x00A0;</td>
   <td style="padding-left: 130px;">
    <label>Against Invoice</label>
        <s:textfield id="i" name="logindto.transportMode" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Against Invoice" size="50" />
    </td>
    </div>
           </tr>
   ...
   <td style="padding-left: 130px;">
    <label>Date of Invoice</label>
      ...
      <s:textfield id="datepicker1" name="suplydto.urInvoiceDate" onkeypress="return isDecimalKey(event)"  cssClass="form-control " placeholder="Select Date" size="50" />
       </div>
       </td>
    </div>
           </tr>
    ...
    <label>State: </label>
     ...
     <s:textfield id="i" name="suplydto.urGstinNo" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="State" size="30" />
         
         </div>
     <div style="float: right">
     <label>Code: </label>
     <s:textfield id="i" name="suplydto.urGstinNo" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Code" size="15" />
            </div>
            </div>
        </td>
   ...
   <tr>
        <td style="padding-left: 80px;">
    <label>Name</label>
     <s:textfield id="i"  name="receiverName" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Name" size="50" />
    </td>
   ...
   <td style="padding-left: 130px;">
    ...
    <label>Name(Tick if name is same)</label>
        <s:textfield id="i" name="consigneeName" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Name" size="50" />
    </td>
    </div>
           </tr>
    ...
    <div class="block">
        ...
        <td style="padding-left: 80px;">
    <label>Address</label>
      <s:textarea id="i" name="receiverAddress"  rows="4" cols="20" cssClass="form-control" placeholder="Enter Address"/>
    </td>
    <td>&#x00A0;</td>
   <td style="padding-left: 130px;">
       <input type="checkbox" name="billingtoo1" onclick="FillBilling1(this.form)" id="chk-01"/>
    <label>Address(Tick if address is same)</label>
        <s:textarea id="i" name="consigneeAddress"  rows="4" cols="20" cssClass="form-control" placeholder="Enter Address"/>
    </td>
    </div>
           </tr>
   ...
   <td style="padding-left: 130px;">
    ...
    <label>State: </label>
     ...
     <s:textfield id="i" name="receiverState" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="State" size="30" />
         
         </div>
     <div style="float: right">
     <label>Code: </label>
     <s:textfield id="i" name="receiverPincode" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Code" size="15" />
            </div>
            </div>
        </td>
    <td>&#x00A0;</td>
   <td style="padding-left: 130px;">
    ...
    <label>State(Tick if state is same)</label>
      <s:textfield id="i" name="consigneeState" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="State Of Consignee" size="30" /> </div>
     <div style="float: right">
         <label style="margin-top: 1.1%">Code: </label>
     <s:textfield id="i" name="consigneePincode" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="State Code" size="15" />   </div>
            </div>
   </td>
    ...
    <table  border="1" style="border-collapse: collapse;" id="one1"> 
      <tr>
         ...
         <th rowspan="2"  style="text-align: center;">Qty</th>
           <th rowspan="2">Basic value before Tax</th>
           <th rowspan="2">Basic value After Tax</th>
       ...
       <td><s:textfield name="logindto.sgstAmt" readonly="true" id="samt" cssClass="form-control"  theme="simple"></s:textfield></td>
        <td><s:textfield name="logindto.total" readonly="true" onkeyup="multiplication2()" id="total"  cssClass="form-control"  theme="simple"></s:textfield></td>
          ...
          <table border="1" width="100%">
               ...
               <tr>
   <td width="18.1%"  class="text-center"><b>Total</b></td>  
   <td><s:textfield name="logindto.totTaxVal" size="6.5" id="i" cssClass="form-control totalPrice1" readonly="true" theme="simple"></s:textfield></td>
  
   <td><s:textfield name="logindto.totCgst" size="6.5" id="i" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
   
   <td><s:textfield name="logindto.totSgst" size="6.5" id="i" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>

<td><s:textfield name="logindto.totIgst" size="6.5" id="i" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
...
<td><s:textfield name="logindto.totIgst" size="6.5" id="i" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
  <td><s:textfield name="logindto.totIgst" size="6.5" id="i" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
   ...
   <table border="1" width="100%">
        <tr>
      <td width="91%"><b><center>Total Amount&#8377;</center></b></td>
   <td><s:textfield name="form.totalOpeningStock" size="15" id="totalPrice1" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
    ...
    <div class="block">
        ...
        <td>&#x00A0;</td>
   <td style="padding-left: 80px;">
        <b><u><span style="word-spacing: 3px;">BANK DETAILS</span></u></b>
        <br/>
        
        <label>Bank A/C </label>
       <div>
               <s:textfield id="i" name="logindto.authName"  onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Enter A/C" size="50" />
               
            </div>
               <label>Bank IFSC</label>
               <div>
               <s:textfield id="i" name="logindto.authDesign"  onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Enter IFSC code" size="50" />
    ...
    <label>Terms And Conditions</label>
      <s:textarea id="i" name="logindto.termsConditions"  rows="4" cols="55" cssClass="form-control"/>
              ...
              <table>
                  <tr><td style="padding-left: 470px;"><s:submit value="submit"  cssClass="btn btn-primary"/>   
        </td></tr>
</table>
